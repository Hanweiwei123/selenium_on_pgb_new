...
class EditAccountPage
    ...
    def add_ios_signing_key valideOne_or_invalidOne = "valid"
        ...
        if(os == "win")
            ea_signing_keys(:ios_choose_cert_file_btn).send_keys("C:\\signing_key\\ios\\LichuanIQEKey.p12")
            ea_signing_keys(:ios_choose_prov_file_btn).send_keys("C:\\signing_key\\ios\\Lichuanlu.mobileprovision")
        else
    ...
    def add_android_signing_key valideOne_or_invalidOne    
        ...
        if(os == "win")
            ea_signing_keys(:android_choose_keystore_btn).send_keys("C:\\signing_key\\android\\android-dilato.keystore")
        else
    ...
    def add_blackberry_signing_key valideOne_or_invalidOne
        ...
        if(os == "win")
            ea_signing_keys(:blackberry_choose_csk_btn).send_keys("C:\\signing_key\\blackberry\\barsigner.csk")
            ea_signing_keys(:blackberry_choose_db_btn).send_keys("C:\\signing_key\\blackberry\\barsigner.db")
        else
